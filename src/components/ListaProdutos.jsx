                ...
                <tbody>
                    <tr>
                        <td>
                            ...
                            <p className="precoProduto">R$: 8,00</p>
                        </td>
                        <td>
                            <p className="tituloProduto">Cheddar</p>
                            <img src="/images/cheddar.jpg" alt="Cheddar" />                                
                            <p className="precoProduto">R$: 17,00</p>
                        </td>
                        <td>
                            <p className="tituloProduto">Bata Frita</p>
                            <img src="/images/batata.jpg" alt="Batata Frita" />                                
                            <p className="precoProduto">R$: 7,00</p>
                        </td>
                    </tr>
                    <tr>
                        <td>
